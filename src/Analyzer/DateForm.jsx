...
/**
 * This component displays form for getting user input of start date 
 * and end date and sends request to CoinGecko API when form is submitted.
 *
 * @param {function} callbackToParent Callback function to return form data
